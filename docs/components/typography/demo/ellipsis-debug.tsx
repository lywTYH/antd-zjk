    ...
    <>
      ...
      {longText ? (
        <Paragraph ellipsis={{ rows, expandable }} copyable={copyable} editable={editable}>
          Csces, a design language for background applications, is refined by Ant UED Team. This is
          a nest sample{' '}
      ...
      <Text style={{ width: 100 }} ellipsis copyable>
        Csces is a design language for background applications, is refined by Ant UED Team.
      </Text>
